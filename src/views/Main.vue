...
<template>
    <div class="main" :class="{'main-hide-text': hideMenuText}">
        <div class="sidebar-menu-con" :style="{width: hideMenuText?'60px':'240px', overflow: hideMenuText ? 'visible' : 'auto', background: $store.state.menuTheme === 'dark'?'#495060':'white'}">
            <div class="logo-con">
        ...
        <div class="main-header-con" :style="{paddingLeft: hideMenuText?'60px':'240px'}">
        ...
        <div class="single-page-con" :style="{left: hideMenuText?'60px':'240px'}">
